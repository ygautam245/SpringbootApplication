...
<html>
    ...
    <body>
        <header id="header" align="center">Library Management System</header>
        <div class="ctn container-fluid" align="center">
            <div class="card text-dark bg-light mb-5">
                <div class="heading">
                    <div class = "row">
                        <label class="form-label"><h2>Sign Up</h2></label>
                        <label class="form-label">Manage Books Easily</label>
                    </div>
                </div>
                <div class="mb-3 mt-4">
                    <form:form action="sign-up" method="post" modelAttribute="librarian">
                        <div>
                        ...
                        <div class="log-btn d-grid gap-2">
                            <input type="submit" class="btn btn-primary mb-3" value="SignUp" />
                        </div>
