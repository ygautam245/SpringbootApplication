    ...
    <body>
        ...
        <div class="ctn container-fluid" align="center">
            <div class="card text-dark bg-light mb-3">
                <div class="heading mt-3">Add Book Details</div>

                <form:form class="p-4" action="checkBook" modelAttribute="book">
                    <div class="row mt-1">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-auto">
                            <form:input class="form-control" path="date" readonly="true" style="width: 20rem;"/>
                        </div>
                    </div>
